...
function setup(){
  /** Loads the data from the CSV file, held on github */
    ...
    var circleAttr={
      ...
      stroke:"white",
          ...
          .on("mouseover", function(d) {
            //Generates a tooltip element when the mouse is hovered over a planet		
            div.transition()		
                .duration(200)		
                .style("opacity", .9);		
            ...
            //Removes a tooltip element when the mouse is moved from over a planet		
